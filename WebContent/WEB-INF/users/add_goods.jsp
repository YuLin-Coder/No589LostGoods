      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
             <form  enctype="multipart/form-data" action="GoodsServlet?method=addGoodsAct1" method="post" >
           ...
           <input type="hidden" name="type" value="${type}"/>
            ...
            <div class="layui-input-inline">
              <textarea type="text" name="info" id="info" placeholder="请输入丢失物品特征" class="layui-textarea"></textarea>
            </div>
          </div>        
            ...
            <div class="layui-form-item">
                  <label class="layui-form-label">失物时间：</label>
                  <div class="layui-input-inline">
