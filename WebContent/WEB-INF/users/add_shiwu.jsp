      ...
      <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <div class="layui-card-body" pad15>
             <form enctype="multipart/form-data"  action="ShiwuServlet?method=addShiwuAct" method="post" >
           ...
           <input type="hidden" name="type" value="${type}"/>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="wpname" id="wpname" value=""  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
              ...
              <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="file" name="imgUrl" id="imgUrl" value=""  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
            ...
            <div class="layui-input-inline">
              <textarea type="text" name="detail" id="detail" placeholder="请输入拾物品详情" class="layui-textarea"></textarea>
            </div>
          </div>   
           ...
           <div class="layui-form-item ">
            ...
            <div class="layui-input-inline">
              <textarea type="text" name="place" id="place" placeholder="请输入拾物品地点" class="layui-textarea"></textarea>
            </div>
          </div>        
            ...
            <div class="layui-form-item">
              ...
              <div class="layui-form-item">
                <div class="layui-input-block">
                  <button class="layui-btn" type="submit" id="addShiwu">确认添加</button>
                  <a href="ShiwuServlet?method=findBySnameAct&sname=${username }" class="layui-btn layui-btn-primary" >返回</a>
                </div>
              </div>
              </form>
            </div>
...
layui.use([ 'form','jquery','layer','laydate' ], function() {
	var form = layui.form,
	 ...
	 $('#addShiwu').click(function(){  
		  var $1 = $.trim($('#sname').val());
		  var $2 = $.trim($("#wpname").val());
		  var $3 = $.trim($("#imgUrl").val());
