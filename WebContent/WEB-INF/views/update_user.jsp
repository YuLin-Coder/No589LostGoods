           ...
           <div class="layui-form" lay-filter="">
              <div class="layui-form-item">
               ...
               <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="realname" value="${list.realname }" id="realname" value=""  lay-verify="required" lay-verType="tips" class="layui-input">
                </div>
              </div>
            ...
            <div class="layui-form" lay-filter="">
              ...
              <input type="hidden" name="type" value="1" /></c:if>
              <c:if test="${type==2 }">
