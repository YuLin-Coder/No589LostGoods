    ...
    <div class="layadmin-user-login-main">
      ...
      <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
        <div class="layui-form-item">
          ...
          <input type="text" name="username" lay-verify="username" id="username"  value="${username }" placeholder="登录账号" class="layui-input">
          <div><span id="msg" style="color:red;">${msg }</span></div>
        </div>
        
         <div class="layui-form-item">
          <label class="layadmin-user-login-icon layui-icon layui-icon-realname" for="LAY-user-login-cellphone"></label>
          <input type="text" name="realname" lay-verify="realname" id="realname"  placeholder="真实姓名" class="layui-input">
       ...
       <div class="layui-form-item">
        ...
        <div class="layui-form-item">  
         <button type="submit" id="registerUser" class="layui-btn layui-btn-fluid">注册</button>
          ...
          <div class="layui-form-item">
 	<a href="LoginServlet?method=login" class="layui-btn layui-btn-fluid" >返回登录</a>
