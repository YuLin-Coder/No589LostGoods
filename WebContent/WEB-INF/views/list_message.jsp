...
<fieldset class="layui-elem-field layui-field-title" style="margin-top: 20px;">
 ...
 <div class="layui-col-md12">
        <div class="layui-card">
          ...
          <a href="MessageServlet?method=messageListAct2" class="layui-btn layui-btn-primary" >返回列表</a>
    ...
    <td>${m.createTime }</td>
       ...
       <td>
    		 ...
    		 <a onclick="return del();" href="MessageServlet?method=deleteMessageAct&id=${m.id}" class="layui-btn layui-btn-sm layui-btn-danger"><i class="layui-icon">&#xe640;</i></a></td>
    		</c:if>
    </tr>
   </c:forEach>
              </tbody>
