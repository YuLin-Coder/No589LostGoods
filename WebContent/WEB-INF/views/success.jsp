...
%>
	<font color="black" size="5"><br>注册成功!三秒后将跳转到登录页面 <br>	
		如果没有跳转,请点击 <a href="LoginServlet?method=login">这里</a>进行登录!!! <br>
			</font>	
<%		
	} 
else {	
		...
		response.setHeader("refresh","3;URL=UserServlet?method=toRegsiteAct");	
							%>
							<font color="black" size="5"> 注册失败！信息有误<br> 三秒后将跳转到注册页面 ，请重新注册<br>		
